package Cater::DBSchema::Result::UserLog;
...
Cater::DBSchema::Result::UserLog


=head1 DESCRIPTION AND USAGE

Database object representing UserLog entries within the web app.

=cut

__PACKAGE__->table( 'user_logs' );
